...
# by settingb a global variable. You would never use a global variable
...
class Home
  ...
  # The production Terratowns uses is rails and uses
...
# turn this generaic class to utilise the sinatra web framework
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # the user_uuid should be matching for user
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # assign the patload to variables
    ...
    # printing out variables out to comsole to make it easier
    # to see or debug we have inputed into this endpoint.
    puts "name #{name}"
    ...
    puts "uuid #{uuid}"
    # will mock save our data to a mock database
